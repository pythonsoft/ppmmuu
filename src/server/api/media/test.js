...
describe('/media', () => {
  ...
  describe('POST /media/esSearch', () => {
    it('should media esSearch', (done) => {
      agent
          .post('/media/esSearch')
          .send({ source: 'id,duration,name,ccid,program_type,program_name_en,hd_flag,program_name_cn,last_modify,content_introduction,content,news_data,program_name,from_where,full_text,publish_time,rootid', match: [{ key: 'program_type', value: [] }, { key: 'ccid', value: [] }, { key: 'news_type', value: [] }, { key: 'occur_country', value: [] }, { key: 'versions', value: [] }, { key: 'production_site', value: [] }, { key: 'resource_location', value: [] }, { key: 'publish_status', value: 1 }], should: [], range: [{ key: 'news_data', gte: '', lt: '' }, { key: 'airdata', gte: '', lt: '' }], hl: 'name,program_name_en,program_name_cn,content,content_introduction,house_num,from_where,full_text', sort: [{ key: 'publish_time', value: 'desc' }], start: 0, pageSize: 20, t: 1512472442646 })
          .end((err, res) => {
